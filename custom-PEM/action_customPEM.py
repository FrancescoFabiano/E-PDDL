...
class Action:
    ...
    def __init__(self,  name, act_type, parameters, positive_preconditions, negative_preconditions, add_effects, del_effects, observers, obs_groups, derive_cond = [], explicit_eff = [], extensions = None):
    ...
    def __str__(self):
        ...
        for obs_group in self.obs_groups:
            ret = ret + '\n  agents in ' + str(obs_group) + " are: " + str([list(i[0]) + list(i[1]) for i in self.observers[obs_group]]) + '\n'
